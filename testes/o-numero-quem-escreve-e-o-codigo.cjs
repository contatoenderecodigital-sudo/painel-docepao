...
fs.writeFileSync(
  ...
  [
    ...
    "  ['dados_dia', p({...soBolo, pecas:{topo:true,papelDeArroz:true}, topoNome:'Arthur', topoIdade:'5 anos', tema:'Minnie'})],",
    "  ['dados_pagamento', p({...soBolo, pecas:{topo:true,papelDeArroz:true}, topoNome:'Arthur', topoIdade:'5 anos', tema:'Minnie', dados:{nome:'Sandro',data:'12/09',hora:'11:30',pagamento:null}})],",
    "  ['confirmacao', p({...soBolo, pecas:{topo:true,papelDeArroz:true}, topoNome:'Arthur', topoIdade:'5 anos', tema:'Minnie', dados:{nome:'Sandro',data:'12/09',hora:'11:30',pagamento:'pix'}})],",
    "];",
