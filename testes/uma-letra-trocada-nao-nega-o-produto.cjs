...
fs.writeFileSync(
  ...
  [
    ...
    "  // LETRAS TROCADAS DE LUGAR: o erro mais comum de quem digita no celular,",
    "  // e o que a primeira versao desta regra perdia inteiro. Levenshtein puro",
    "  // conta 'coxniha' como DUAS edicoes; pra quem digitou e uma so.",
    "  ['salgado', 'coxniha', 'coxinha'],",
    "  ['salgado', 'ocxinha', 'coxinha'],",
    "  ['salgado', 'coxinah', 'coxinha'],",
    "  ['docinho', 'brigaderio', 'brigadeiro'],",
    "  ['docinho', 'beijniho', 'beijinho'],",
    "  // Letra comida em nome curto: o piso de tamanho e do CARDAPIO, e nao do",
    "  // que o cliente digitou. Estava nos dois, e 'chodo' sem uma letra ficava",
    "  // com quatro e nem era olhado.",
    "  ['salgado', 'chdo', 'chodó'],",
