...
const SONDA = [
  ...
  "});",
  "",
  "// 5. O QUE O MODELO DEVOLVE DE VERDADE, lido no rastro da producao:",
  "//",
  "//     modelo leu: 2x pizza [calabresa e frango com catupiry]",
  "//",
  "// Produto e NOME DE FAMILIA ('pizza', nao 'pizza inteira'), e os sabores vem",
  "// juntos por ' e '. As duas coisas eu tinha suposto errado antes, e as duas",
  "// custaram um deploy que nao moveu o banco.",
  "const juntos = await rodar(VAZIO, 'quero 2 inteiras, uma de calabresa e uma de frango com catupiry', {",
  "  itens: [{ produto: 'pizza', qtd: 2, sabor: 'calabresa e frango com catupiry' }],",
  "});",
  "",
  ...
  "  itens: [{ produto: 'pizza', qtd: 1, sabor: 'calabresa e frango com catupiry' }],",
  "});",
  "",
  ...
  "  itens: [{ produto: 'pizza', qtd: 5, sabor: 'calabresa e frango com catupiry' }],",
  "});",
  "",
