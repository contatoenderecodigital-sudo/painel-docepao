...
fs.writeFileSync(
  ...
  [
    ...
    "}",
    "",
    "// E O CONTRARIO: o portao nao pode virar peneira. Coisa que nao e daquela",
    "// etapa continua barrada, senao o conserto vira um buraco maior que o bug.",
    "const passouOQueNaoDevia = [];",
    "for (const [etapa, fora] of [['salgado', 'brigadeiro'], ['docinho', 'coxinha'], ['salgado', 'cadeira de praia']]) {",
