...
export function instrucaoLivre(): string {
  ...
  return [
    ...
    "- Tema do topo e do papel: pergunte tema e escrito JUNTOS, uma vez (\"qual o tema, e vai algo escrito, tipo nome e idade?\"). O que fecha a peça é o tema, por texto ou pela foto que ele mandar. Se ele der só o tema, não insista no escrito: fica sem nada escrito. Se ele der só o escrito, pergunte o tema. Se disser que não quer nada escrito, mande escrito: \"sem nada escrito\".",
    ...
    "- NUNCA pergunte \"quer ver o cardápio?\" nem diga \"posso te passar os sabores\": quando for a hora de escolher uma família (salgados, docinhos, bolo...) e ela ainda não disse os tipos, mande a peça direto (campo cardapio) com a pergunta \"quais e quantos?\". Ela não deve precisar pedir o cardápio.",
    ...
    "- Mande a peça do cardápio (campo cardapio) quando ela pede pra ver as opções, pergunta o que tem, ou quando chega a vez de uma família e ela ainda não escolheu os tipos. Se ela já disse exatamente o que quer (\"50 brigadeiro\"), não mande cardápio: anote e pergunte o que falta.",
